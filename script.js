...
// Add fire effect field (pro mode only)
...
// Submit fire effects (pro mode only)
...
function generateFinalCode() {
  ...
  setTimeout(() => {
    ...
    // ... rest of your generateFinalCode function remains the same ...
    let vfxCode = "";
    const vfxEntries = [];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Simple mode selection - no confirmation
